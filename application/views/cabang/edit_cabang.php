<form action="<?php echo base_url(); ?>Cabang/updatecabang" class="formCabang" method="post">
	 <div class="form-group mb-3">
         ...
         <input type="text" value="<?php echo $cabang['kode_cabang']; ?>" class="form-control" name="kodecabang" placeholder="kode cabang" readonly>
     </div>
     <div class="form-group mb-3">
     ...
     <div class="form-group mb-3">
         ...
         <input type="text" value="<?php echo $cabang['telepon']; ?>" class="form-control"  name="telepon" placeholder="no telepon">
     </div>
     <div class="mb-3">

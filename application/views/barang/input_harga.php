<form action="<?php echo base_url(); ?>Barang/simpanharga" class="formHarga" method="post">
	 <div class="form-group mb-3">
         ...
         <input type="text" class="form-control" name="kodeharga" id="kodeharga" placeholder="kode harga" readonly>
     </div>

     <div class="form-group mb-3">
         <label class="form-label">Barang</label>
         <select name="kodebarang" id="kodebarang" class="form-select" required>
     ...
     <div class="form-group mb-3">
         ...
         <input type="text" class="form-control" name="harga" id="harga" placeholder="kode harga" required>
     </div>
     ...
     <div class="form-group mb-3">
         ...
         <select name="cabang" id="cabang" class="form-select" required>
         	...
         	<?php foreach($cabang as $c) : ?>
         		<option value="<?php echo $c->kode_cabang; ?>"><?php echo $c->kode_cabang." ".$c->nama_cabang; ?></option>
            <?php endforeach; ?>
         </select>
     </div>
